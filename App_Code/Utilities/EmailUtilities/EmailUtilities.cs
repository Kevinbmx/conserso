...
namespace Concerso.App.Utilities.Email
{
    /// <summary>
    ...
    public class EmailUtilities
    {
        ...
        static public void SendEmail(string to, string from, string subject, string message)
        {
            ...
            emailMessage.From = new System.Net.Mail.MailAddress(from, "Concerso");
            ...
            try
            {
                ...
                //string file = appPath + "Images\\logo-powerbike.png";
                string file = appPath + "images\\Fondo.svg";
                ...
                logoMessage = logoMessage + " style=\"width:150px\">";
        ...
        {
            string from = ConfigurationManager.AppSettings.Get("correo");
        ...
        public static void SendEmailToAdministrator(string message, string subject)
        {
            ...
            try
            {
                admMail = ConfigurationManager.AppSettings.Get("correo");
            ...
            List<EmailFileParameter> parameters, List<System.Net.Mail.Attachment> theAttachedList)
        {
            ...
            try
            {
                ...
                System.Net.Mail.MailMessage emailMessage = new System.Net.Mail.MailMessage();
                emailMessage.From = new System.Net.Mail.MailAddress(from, "Conserso");
                emailMessage.IsBodyHtml = true;
                emailMessage.Subject = subject;
